 ...
 * Author: Paola Alcala
 *
 * Created on January 29, 2024, 1:24 PM
...
//    //players ask each other for a card
    ...
    while (deckSize > 0) {
        ...
        switch (players) {
            case 1: {
                ...
                while (true) {
                    ...
                    if (p2Hand.find(to_string(snglCrd)) != string::npos) {
            ...
            case 2: {
                ...
                while (true) {
                    ...
                    if (p1Hand.find(to_string(snglCrd)) != string::npos) {
                        cout << "Yes, I have " << snglCrd << endl << endl;
        ...
        // Update deck size and shuffle logic
        // (Update deckSize and shuffling logic)
...
//figure out how to move card from one player hand to the other
