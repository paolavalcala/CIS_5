...
void greetPl(int plrs, const string& pl1 = "Player 1", const string& pl2 = "Player 2");
...
int main(int argc, char** argv) {
   ...
   greetPl(plrs, pl1Nm, pl2Nm);
    ...
    cout << "No cards left in the deck. Game over." << endl;
    ...
    cout << pl1Nm << "'s score: " << pl1Score << ", Square root of the score: " << pl1Root << endl;
    cout << pl2Nm << "'s score: " << pl2Score << ", Square root of the score: " << pl2Root << endl;
